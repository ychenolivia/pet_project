<html>
    ...
    <body style="background-color: #ffe6e6;">
        ...
        <div class="navbar collapse navbar-collapse" id="navbarTogglerDemo01">
          <!--<a class="navbar-brand petgoTitle" href="../Home.php" style={font-family: "Bradley Hand";}>PetGo</a >-->
          <?php
            $user = $_GET["ID"];
        ...
        <div>
            <div>
                <div style="float:left;margin:10px 10px; width:10%;background-color: #ffe6e6;align:center;">
                    <!--<button id="loginb" class="btn btn-outline-secondary btn-lg" style="align:center;" onclick="window.location.href='profile2.php'">Posted</button>
                    <br><br>
                    
                    <button id="loginb" class="btn btn-outline-secondary btn-lg" onclick="window.location.href='profile_apply.php'">Applied</button>
                    -->
                    <?php
                         $user = $_GET["ID"];
                          print("<a  class=\"btn btn-outline-secondary btn-lg\"  href=\"profile2.php?ID=$user\" style=\"align:center;\">Posted</a >"
                            );
                    ?>
                    <br><br>
                    <?php
                         $user = $_GET["ID"];
                          print("<a  class=\"btn btn-outline-secondary btn-lg\"  href=\"profile_apply.php?ID=$user\" style=\"align:center;\">Applied</a >"
                            );
                    ?>
                </div>
            </div>
  ...
  <img class=\"card-img-top\" src=\"{$row['photo']}\" alt=\"No images\">
  <div class=\"card-body\">
